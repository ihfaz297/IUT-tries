#!/usr/bin/env python3
"""Label whether codemix main answers are hallucinated using Ollama gemma2:27b.
...
Usage:
    python Codemix/label_codemix_main_gemma_ollama.py \
        --input "Codemix/Main dataset/codemix_1000.csv" \
        --output "Results/codemix_1000_main_gemma_labeled.csv" \
