#!/usr/bin/env python3
"""Label whether codemix main answers are hallucinated using Ollama llama3.1:8b.
...
Usage:
    python Codemix/label_codemix_main_llama_ollama.py \
        --input "Codemix/Main dataset/codemix_1000.csv" \
        --output "Results/codemix_1000_main_llama_labeled.csv" \
