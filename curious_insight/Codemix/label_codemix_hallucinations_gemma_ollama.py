#!/usr/bin/env python3
"""Label whether codemix hallucinated candidates are hallucinated using Ollama gemma2:27b.
...
Usage:
    python Codemix/label_codemix_hallucinations_gemma_ollama.py \
        --input "Hallucination Generated Answers/codemix_4000.csv" \
        --output "Results/codemix_4000_hallucinations_gemma_labeled.csv" \
